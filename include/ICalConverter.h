...
class ICalConverter {
       ...
       */
       ...
       template<class T> void exportSummaryFromLocal(icalcomponent *pEntcomp, T *pComp);
       template<class T> void exportLocationFromLocal(icalcomponent *pEntcomp, T *pComp);
       template<class T> void exportDescriptionFromLocal(icalcomponent *pEntcomp,  T *pComp);
       ...
       template<class T> void exportCommentsFromLocal(icalcomponent *pEntcomp, T *pComp);
